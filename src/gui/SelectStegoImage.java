...
/**
 * The Select Stego Image class. The class is responsible for
 * displaying the select stego image screen in Revelation
 * @author Sean Hamlin
 * @version 1.1
 * @since 1.0
 */
public class SelectStegoImage 
{
	...
	private static JTextPane filePathString;
	private static JButton open;
	private static JLabel actualSize;
	private static JLabel actualDate;
	...
	private static JLabel selectStegoImage;
	private static JLabel fileProperties;
    ...
    public void addComponentsToPane(Container pane) 
	{
		...
		final ImageIcon selectStegoFileIcon = loadIcon("selectStegoImage.jpg");
		selectStegoImage = new JLabel(selectStegoFileIcon);
		...
		selectStegoImage.setToolTipText("Step 1");
		selectStegoImage.setPreferredSize(new Dimension(350, 35));
        c.gridx = 0;
        c.gridy = 1;
		//c.gridwidth = 1;
    ...
    private void createAndShowGUI() 
	{
        ...
        frame = new JFrame("Revelation - Reveal (Step 1)");
	 ...
	 */
	public SelectStegoImage(RevealControl revealControl) {
	...
	public void CreateGUI()
	{
		if (revealControl == null)
			revealControl = new RevealControl();
	...
	/**
	 * Takes you to Step 2 of Reveal
	 * @author Sean Hamlin
	 */
	private class rightButtonAction implements ActionListener	{
		public void actionPerformed(ActionEvent arg0) {
			frame.dispose();
			new DecodeStegoImage(revealControl).CreateGUI();
		}
	}
	...
	private class openFileButtonAction implements ActionListener {
		public void actionPerformed(ActionEvent arg0) {
			...
			int result = fc.showDialog(frame, "Reveal");
			...
			else
			{
				...
				revealControl.setStegoImageFileName(fileName);
	...
	private class previewButtonAction implements ActionListener	{
		public void actionPerformed(ActionEvent arg0) {
			...
			if (fileName == null) {
				JOptionPane.showMessageDialog(frame  , "Please select a Stego Image first !", "Preview", JOptionPane.INFORMATION_MESSAGE);
			}
			else {
	...
	private class helpButtonAction implements ActionListener	{
		public void actionPerformed(ActionEvent arg0) {
			new HelpDialog(frame, "revealStepOne.html", "Help with Reveal (Step 1)");
		}
	}
}
