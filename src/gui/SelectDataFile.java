...
public class SelectDataFile 
{
    ...
    public void addComponentsToPane(Container pane) 
	{
		...
		preview = new JButton(previewIcon);   //width, height
		preview.setPreferredSize(new Dimension(94, 81));
		...
		final ImageIcon selectDataFileIcon = loadIcon("selectDataFile.jpg");
		selectDataFile = new JLabel(selectDataFileIcon);
		...
		fileName = concealControl.getDataFileName();
		...
		selectDataFile.setToolTipText("Step 1");
		selectDataFile.setPreferredSize(new Dimension(350, 35));
		//selectDataFile.setBackground(Color.BLACK);
		//selectDataFile.setForeground(Color.ORANGE);
        c.gridx = 0;
        c.gridy = 1;
		//c.gridwidth = 1;
		...
		help.setMnemonic('H');
		help.setPreferredSize(new Dimension(85, 10));//10
        c.gridx = 3; 
        c.gridy = 5; //4
		c.gridheight = 1; //2
		c.gridwidth = 1; 
    ...
    private void createAndShowGUI() 
	{
        ...
        frame = new JFrame("Revelation - Conceal (Step 1)");
	 ...
	 */
	public SelectDataFile(ConcealControl concealControl) {
	...
	/**
	 * Takes you to Step 2 of Conceal
	 * @author Sean Hamlin
	 */
	private class rightButtonAction implements ActionListener	{
		public void actionPerformed(ActionEvent arg0) {
			frame.dispose();
			new SelectCoverFile(concealControl).CreateGUI();
		}
	}
	...
	private class openFileButtonAction implements ActionListener {
		public void actionPerformed(ActionEvent arg0) {
			...
			else
			{
				...
				concealControl.setDataFileName(fileName);
	...
	private class previewButtonAction implements ActionListener	{
		public void actionPerformed(ActionEvent arg0) {
			...
			if (fileName == null) {
				JOptionPane.showMessageDialog(frame  , "Please select a Data File first !", "Preview", JOptionPane.INFORMATION_MESSAGE);
			}
			else {
	...
	private class helpButtonAction implements ActionListener	{
		public void actionPerformed(ActionEvent arg0) {
			new HelpDialog(frame, "concealStepOne.html", "Help with Conceal (Step 1)");
		}
	}
}
